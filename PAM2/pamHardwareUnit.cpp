...
{
   // устанавливаем положени€ элементов управлени€ в соответствии со значени€ми
   // полученными из главного окна приложени€.
	...
	SpinEdit3->OnChange = NULL;
	GroupBox1->Caption = L"Ёкспозици€ " + IntToStr(pamMainForm->Exposure) + L" мкс";
	...
	SpinEdit2->OnChange = NULL;
	GroupBox5->Caption = L"”силение " + IntToStr(pamMainForm->Gain) + L" dB";
	...
	SpinEdit1->OnChange = NULL;
	GroupBox1->Caption = L"ƒлительность " + IntToStr(pamMainForm->LFlash) + L" мкс";
